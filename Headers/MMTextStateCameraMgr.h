...
@class MMTextStateCameraViewController, NSString;

@interface MMTextStateCameraMgr : MMUserService <MMSightCameraViewControllerDelegate, MMServiceProtocol>
{
    MMTextStateCameraViewController *_cameraVC;
}

- (void).cxx_destruct;
@property(nonatomic) __weak MMTextStateCameraViewController *cameraVC; // @synthesize cameraVC=_cameraVC;
