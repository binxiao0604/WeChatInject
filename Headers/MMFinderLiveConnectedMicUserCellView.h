...
@class MMFinderLiveConnectMicUser, MMUIActivityIndicatorView, MMUIButton, UILabel, UIView;
...
@interface MMFinderLiveConnectedMicUserCellView : UITableViewCell
{
    ...
    MMUIActivityIndicatorView *_activityIndicatorViewInBtn;
}

+ (id)ReuseIdentifier;
- (void).cxx_destruct;
@property(retain, nonatomic) MMUIActivityIndicatorView *activityIndicatorViewInBtn; // @synthesize activityIndicatorViewInBtn=_activityIndicatorViewInBtn;
...
- (void)configActivityIndicatorViewInBtn;
