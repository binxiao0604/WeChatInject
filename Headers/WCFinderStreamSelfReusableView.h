...
@class FinderWxAppInfo, MMBadgeView, MMUIImageView, MMUILabel, MMWebImageView, NSString, RichTextView, UIButton, UIImageView, UILabel, UIView, WCFinderAuthInfoIconView, WCFinderContact, WCFinderHeadImageView, WCFinderProfileCardContainer, WCFinderProfileRedPacketEventView, WCFinderStreamProfileExtInfo;
@protocol WCFinderStreamHeaderActionProtocol;

@interface WCFinderStreamSelfReusableView : UICollectionReusableView <WCFinderHeadImageViewDelegate, ILinkEventExt, WCFinderLiveNoticeViewDelegate, WCFinderProfileEventViewDelegate, WCFinderProfileRedPacketEventViewDelegate>
{
