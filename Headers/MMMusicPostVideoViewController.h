...
@class MMMusicMVModel, MMMusicPostVideoTabFinderController, MMMusicPostVideoTabView, MMScrollView, MMUIButton, MVEditStatInfo, NSMutableArray, NSString;
...
- (void)viewDidLoad;
- (void)loadView;
- (id)initWithMVModel:(id)arg1 statInfo:(id)arg2;
