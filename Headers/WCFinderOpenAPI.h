...
+ (void)pushFinderProfileWithExportUserName:(id)arg1 currentNavController:(id)arg2 cardType:(unsigned long long)arg3 enterScene:(unsigned long long)arg4 reportExtraInfo:(id)arg5;
