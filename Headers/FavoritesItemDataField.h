...
@class FavBrandMpVideoItem, FavLocationItem, FavProductItem, FavStreamVideoItem, FavTVItem, FavURLItem, FavWeAppItem, FavoritesDataItemSource, MMMusicShareItem, NSArray, NSString, UIImage, WCFinderContentColumnSharedItem, WCFinderLiveShareItem, WCFinderMessageShareNameCard, WCFinderShareToMomentsItem, WCFinderTopicShareItem, WCMegaVideoShareItem;
...
@property(retain, nonatomic) UIImage *curThumbImage; // @synthesize curThumbImage=_curThumbImage;
