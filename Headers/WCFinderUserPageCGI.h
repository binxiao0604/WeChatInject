...
- (void)createRequest;
- (id)initWithContactUsername:(id)arg1 maxTid:(unsigned long long)arg2 reportScene:(unsigned long long)arg3 needFansCount:(_Bool)arg4 lastBuffer:(id)arg5 tabType:(int)arg6 topicId:(unsigned long long)arg7 enterType:(unsigned int)arg8 clientStatus:(id)arg9 successful:(CDUnknownBlockType)arg10 failure:(CDUnknownBlockType)arg11;
