...
@interface MsgImgFullScreenViewController : MMUIViewController <MMScrollableActionSheetWithVerticalRowsDelegate, GetQRCodeInfoLogicDelegate, BaseScanLogicDelegate, WXVideoPlayerViewDelegate, WXVideoPlayerViewTouchDelegate, MsgImgDataLogicDelegate, ForwardMessageLogicDelegate, EditImageForwardAndEditLogicDelegate, WCImageTranslateDelegate, WCActionSheetDelegate, OCRTransHalfScreenViewControllerDelegate, UIViewControllerTransitioningDelegate, MsgImgFullScreenContainerDelegate, IDownloadImageExt, IMsgExt, IMsgRevokeExt, UIViewControllerAnimatedTransitioning>
{
