...
@class MMUIViewController, NSMutableArray, NSMutableDictionary, NSString, WAMainFrameTaskBarSectionViewModel, WAMainFrameTaskBarSectionWeAppViewModel, WAPackageSweeperLogic, WAReportMainFrameTaskBarActionItem, WASearchController;
@protocol WAMainFrameTaskBarLogicDelegate;

@interface WAMainFrameTaskBarLogic : MMObject <IWeDrawManagerExt, WAAppItemManagerExtension, IMiniMizeUserdRecordUpdateExt, WCFinderLiveExt, WAMainFrameTaskBarViewDelegate, WASearchControllerDelegate>
{
