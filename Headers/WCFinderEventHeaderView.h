...
@class MMUIButton, NSString, RichTextView, UIImageView, UILabel, UIView, WCFinderHeadImageView;
...
+ (id)getDescriptionWithText:(id)arg1;
...
- (void)setToDarkMode;
- (void)updateJoinButtonWithEventState:(_Bool)arg1;
