...
- (void)scanSubFolder:(id)arg1 withScanConfig:(id)arg2 withScanStat:(id)arg3 depth:(int)arg4;
- (void)scanFileInFolder:(id)arg1 withScanConfig:(id)arg2 withScanStat:(id)arg3;
- (void)scanFolderBegin:(id)arg1 withScanConfig:(id)arg2 withScanStat:(id)arg3 depth:(int)arg4;
