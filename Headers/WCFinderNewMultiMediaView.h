...
@class EditVideoBGMPlayer, MMTimer, NSString, UICollectionView, UIImage, UIImageView, UILabel, UIPageControl, WCFinderDataItem, WCFinderProgressBarStatusInfo, WCFinderSafeLayoutView;
...
- (void)changeDataWithDataItem:(id)arg1 width:(double)arg2 currentSelectIndex:(unsigned long long)arg3 useTmpThumbImage:(id)arg4 isEnableTopAuthorInfoOnMediaArea:(_Bool)arg5;
