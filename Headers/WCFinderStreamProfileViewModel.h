...
#import "WCFinderProfileDraftListViewModelContentDelegate-Protocol.h"
...
@class ForwardMessageLogicController, NSArray, NSData, NSMutableArray, NSMutableDictionary, NSString, WCFinderContact, WCFinderEventProfileViewModel, WCFinderMegaProfileViewModel, WCFinderMentionedListViewModel, WCFinderProfileCoverUploadCdnMgr, WCFinderProfileDraftListViewModel, WCFinderStreamMusicViewModel, WCFinderStreamProfileExtInfo, WCFinderTopicInfo;
@protocol WCFinderStreamProfileViewModelDelegate;

@interface WCFinderStreamProfileViewModel : NSObject <WCFinderDataItemExt, WCFinderContactExt, WCFinderProfileCoverUploadCdnMgrDelegate, ForwardMessageLogicDelegate, WCFinderPostDataItemExt, WCFinderUserPageFetchExt, WCFinderModUserInfoExt, WCFinderMegaVideoDataExt, WCFinderLiveExt, WCFinderStreamProfileFeedDatasDelegate, WCFinderProfileDraftListViewModelContentDelegate, WCFinderStreamMusicViewModelContentDelegate, WCFinderTopicDataKeyExt>
{
    ...
    WCFinderProfileDraftListViewModel *_privateDraftViewModel;
...
@property(retain, nonatomic) WCFinderProfileDraftListViewModel *privateDraftViewModel; // @synthesize privateDraftViewModel=_privateDraftViewModel;
...
@property(readonly, nonatomic) WCFinderProfileDraftListViewModel *draftViewModel;
