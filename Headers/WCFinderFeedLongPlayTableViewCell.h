...
@class MMUIButton, MMWebImageView, NSObject, NSString, UIButton, UIImageView, UILabel, UIPanGestureRecognizer, UIScrollView, UIStackView, UITapGestureRecognizer, UITextField, UIView, WCFinderAnimationLoadingView, WCFinderBulletGroupView, WCFinderDynamicIconFetchToken, WCFinderFeedContentTextView, WCFinderFeedContentVM, WCFinderFeedImageCDNView, WCFinderFeedMediaWrap, WCFinderMediaInfo, WCFinderMegaVideoViewModel, WCFinderPlayBar, WCPlayerView;
