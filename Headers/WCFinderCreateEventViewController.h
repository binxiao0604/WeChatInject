...
@class CAGradientLayer, MMTextView, MMWebImageView, NSString, UIButton, UIDatePicker, UIImage, UILabel, UIScrollView, UIView, WCFinderEventModel;
@protocol WCFinderCreateEvenDelegate;

@interface WCFinderCreateEventViewController : MMUIViewController <MMImageCropperDelegate, UITextViewDelegate>
{
