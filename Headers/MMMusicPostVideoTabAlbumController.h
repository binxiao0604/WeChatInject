...
@class MMAlbum, MMAlbumDropPickerController, MMAssetForPHAssetFramework, MMMusicPostVideoImagePickerControlCenter, NSMutableArray, NSString, UICollectionView, UICollectionViewFlowLayout;
@protocol MMMusicPostVideoTabAlbumControllerDelegate;

@interface MMMusicPostVideoTabAlbumController : MMMusicPostVideoTabBaseController <MMAlbumDropPickerControllerDelegate, UICollectionViewDelegateFlowLayout, UICollectionViewDataSource, MMSightCameraViewControllerDelegate, MMAlbumChangeObserverExt>
{
