...
@class MMMusicEditVideoCellView, MMMusicLiveCGIMgr, MMMusicLiveLyricDisplayView, MMMusicMVEditorCardCell, MMMusicMVEditorCollectionView, MMMusicMVModel, MMMusicMVPostPublishLogic, MMMusicPostVideoAnimHelper, MMMusicPostVideoViewController, MMTimer, MMUIButton, MVEditStatInfo, NSString, UIView;
...
@interface MMMusicMVEditorViewController : MMUIViewController <MMMusicLyricsRtnExt, UICollectionViewDataSource, UICollectionViewDelegate, MMMusicMVPostPublishLogicDelegate, IMusicPlayerExt, IMMMusicLyricServiceExt, MMMusicPostVideoDelegate, MMMusicEditVideoCellViewDelegate, MMMusicMVEditorCardCellDelegate, MMMusicLiveCGIMgrDelegate>
{
    ...
    NSString *_mvSessionId;
    unsigned long long _fromScene;
    MVEditStatInfo *_statInfo;
...
@property(retain, nonatomic) MVEditStatInfo *statInfo; // @synthesize statInfo=_statInfo;
@property(nonatomic) unsigned long long fromScene; // @synthesize fromScene=_fromScene;
@property(retain, nonatomic) NSString *mvSessionId; // @synthesize mvSessionId=_mvSessionId;
...
- (unsigned long long)convertFrom:(unsigned long long)arg1;
...
- (void)viewDidLoad;
- (void)dealloc;
- (id)initWithMVModel:(id)arg1 mvSessionId:(id)arg2 fromScene:(unsigned long long)arg3;
