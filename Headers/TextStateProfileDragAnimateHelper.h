...
@class CAGradientLayer, CContact, MMUIImageView, MMUILabel, MMUIView, NSDate, NSHashTable, TextStateMediaView, UIButton, UITableView, UIView;
...
- (double)alphaForCurrentOffset:(double)arg1;
