...
- (id)initWithFromContact:(id)arg1 toContact:(id)arg2 appMsgSeq:(unsigned long long)arg3 rewardProductId:(id)arg4 giftItem:(id)arg5 rewardProductCount:(unsigned int)arg6 rewardAmountInWecoin:(unsigned int)arg7 comboProductCount:(unsigned int)arg8 comboId:(id)arg9;
- (id)initWithRewardAppMsgInfo:(id)arg1 appMsgSeq:(unsigned long long)arg2 fromContact:(id)arg3 toContact:(id)arg4;
