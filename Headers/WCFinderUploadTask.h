...
@interface WCFinderUploadTask : NSObject <PBCoding>
{
    ...
    NSMutableArray *_visibilityChatroomIdList;
}
...
@property(retain, nonatomic) NSMutableArray *visibilityChatroomIdList; // @synthesize visibilityChatroomIdList=_visibilityChatroomIdList;
