...
- (void)createRequest;
- (id)initWithFinderUsername:(id)arg1 liveTaskId:(id)arg2 coverImg:(id)arg3 liveDescription:(id)arg4 liveGameAuthTicket:(id)arg5 appId:(id)arg6 liveScene:(int)arg7 location:(id)arg8 successBlock:(CDUnknownBlockType)arg9 failBlock:(CDUnknownBlockType)arg10;
