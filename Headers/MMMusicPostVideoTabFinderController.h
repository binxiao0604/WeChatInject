...
@class MMMusicFinderVideoTabView, MMMusicInfo, MMMusicMVModel, MMMusicSearchVideoController, MMScrollView, MVEditStatInfo, NSMutableArray, NSString;
...
- (id)arrPanGestures;
- (id)initWithViewController:(id)arg1 mvModel:(id)arg2 statInfo:(id)arg3;
