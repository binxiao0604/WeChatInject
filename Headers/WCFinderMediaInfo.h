...
- (_Bool)isMegaVideo;
- (id)getLocalFullUrlPermanentPath;
- (id)getLocalFullScreenThumbPermanentPath;
- (id)getNetFullScreenThumbTempCachePath;
- (id)fullScreenThumbPath;
- (id)getLocalCoverPermanentPath;
- (id)getNetCoverTempCachePath;
- (id)coverPath;
...
- (struct CGSize)mediaFullFeedContentPureHeightWith:(struct CGSize)arg1;
