...
- (void)ensureRedPacketEventView;
- (void)showLongEntryBubbleIfPossible;
- (void)onEntry;
- (void)updateAudienceCount:(unsigned long long)arg1 liveBarMsg:(id)arg2;
...
- (id)updatePrivateLikeButtonImage:(id)arg1;
