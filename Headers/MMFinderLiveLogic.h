...
@class MMFinderLiveConnectMicLogic, MMFinderLiveRedPacketLogic, MMFinderLiveRedPacketMessage, MMFinderLiveTask, MMFinderLiveTaskId, NSString, WCFinderLiveInfo;
@protocol MMFinderLiveLogicDelegate;

@interface MMFinderLiveLogic : MMLiveLogic <WCFinderLiveExt, MMFinderLiveConnectMicActionDelegate, MMFinderLiveRedPacketLogicDelegate, MMLiveCommentViewDelegate>
{
...
- (void)onFinderLiveConnectMicEnd;
- (void)onFinderLiveConnectMicStart;
