...
@class AudioRecorderUserData, CBaseContact, CContact, CEmoticonWrap, CMessageWrap, ChatRoomPanelDynamicWeAppItem, ChatRoomToolMessageEventInfo, LinkWeAppJumpWrap, MMGroupLiveInfoItem, MMGrowTextView, MMInputToolView, MMMusicInfo, MMWebViewController, MsgSendOpEntry, NSArray, NSDictionary, NSMutableArray, NSMutableDictionary, NSNumber, NSString, NSURL, ServiceAppData, SolitaireObj, TranslateInfo, UIBarButtonItem, UIImage, UIScrollView, UIView;
