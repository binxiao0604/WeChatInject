...
- (void).cxx_destruct;
@property(nonatomic) _Bool hasShowSpringEntry; // @synthesize hasShowSpringEntry=_hasShowSpringEntry;
...
- (_Bool)canWCRedEnvelopesMakeRedEnvelopesViewControllerShowSpringEntry;
...
- (void)OnWCRedEnvelopesMakeRedEnvelopesViewControllerHasShowSpringEntry;
