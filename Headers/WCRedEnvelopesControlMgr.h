...
- (unsigned int)startReceiveLiveStreamRedEnvelopesLogic:(id)arg1 messageWrap:(id)arg2 showCustomMessage:(id)arg3;
- (unsigned int)startStreamRedEnvelopesDetailSystemMessageControlLogic:(id)arg1 NativeUrl:(id)arg2;
- (unsigned int)startOpenLiveStreamRedEnvelopesDetail:(id)arg1 sendId:(id)arg2;
- (unsigned int)startReceiveLiveStreamRedEnvelopesLogic:(id)arg1 messageWrap:(id)arg2 liveStreamId:(id)arg3 liveStreamInfo:(id)arg4;
- (unsigned int)startSendLiveStreamEnvelopesLogic:(id)arg1 liveStreamId:(id)arg2 liveStreamInfo:(id)arg3;
