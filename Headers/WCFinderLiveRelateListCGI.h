...
- (id)initWithLastBuff:(id)arg1 tid:(id)arg2 nonceID:(id)arg3 sessionID:(id)arg4 location:(id)arg5 scene:(long long)arg6 commentScene:(unsigned long long)arg7 clientStatus:(id)arg8 liveClientStatus:(id)arg9 successful:(CDUnknownBlockType)arg10 failure:(CDUnknownBlockType)arg11;
