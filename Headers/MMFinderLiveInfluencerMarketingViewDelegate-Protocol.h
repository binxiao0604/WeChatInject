...
@class MMFinderLiveAdsItem, MMFinderLiveGoodsItem, MMFinderLiveShopContext, NSString;
...
- (void)onMMFinderLiveShopAssistantBtnClicked:(MMFinderLiveShopContext *)arg1;
