...
@class MMTextStateDataCachePB, NSMutableDictionary, NSString, TextStateIconDataSource, TextStateLikeLogic, TextStatePermissionLogic, TextStatePublishLogic, TextStateTopicLogic, UIImage;
...
@interface TextStateMgr : MMUserService <TextStatePublishLogicDelegate, IMsgExt, IContactMgrExt, IUpdateProfileMgrExt, TextStateTopicLogicDelegate, TextStateLikeLogicDelegate, MMResourceMgrExt, IWSTemplateConfigDevelopServiceExt, IExptServiceExt, MMKernelExt, MMServiceProtocol>
{
    ...
    _Bool _bShowTextStateIconFuOnlyInTimelineFeed;
    ...
    TextStatePermissionLogic *_permissionLogic;
    TextStateIconDataSource *_appBundleIconDataSource;
...
@property(nonatomic) _Bool bShowTextStateIconFuOnlyInTimelineFeed; // @synthesize bShowTextStateIconFuOnlyInTimelineFeed=_bShowTextStateIconFuOnlyInTimelineFeed;
...
@property(nonatomic) _Bool bShowStateChatBox; // @synthesize bShowStateChatBox=_bShowStateChatBox;
...
@property(retain, nonatomic) TextStateIconDataSource *appBundleIconDataSource; // @synthesize appBundleIconDataSource=_appBundleIconDataSource;
@property(retain, nonatomic) TextStatePermissionLogic *permissionLogic; // @synthesize permissionLogic=_permissionLogic;
...
- (_Bool)tryUpdateResourceFrom:(id)arg1;
- (void)checkIconDataSourcePackage;
- (id)getIconDataInstanceFromZip:(id)arg1 toTempPath:(id)arg2;
- (void)onResUpdateFinish:(long long)arg1 resType:(unsigned int)arg2 subResType:(unsigned int)arg3;
- (void)openWxChatBoxesApp:(id)arg1;
...
- (void)loadExptStatus;
- (_Bool)shouldShowTextStateIconFuOnlyInTimelineFeed;
