...
@class InAppReplayKit2Pusher, MMLiveManger, MMTimer, NSString, TRTCAudioConfig, TRTCCloud, TRTCParams, TRTCRemoteUserManager, TRTCVideoConfig, TestRenderVideoFrame, UIView;
...
@interface TRTCCloudManager : NSObject
{
    ...
    MMTimer *_sendConnectMicSEIMsgTimer;
}

- (void).cxx_destruct;
@property(retain, nonatomic) MMTimer *sendConnectMicSEIMsgTimer; // @synthesize sendConnectMicSEIMsgTimer=_sendConnectMicSEIMsgTimer;
...
- (id)connectMicSEIMsgFromMixUsers:(id)arg1;
- (void)updateCloudMixtureParamsForFinderLiveWithMixUserList:(id)arg1;
...
- (void)sendSEIMessageFromTimer:(id)arg1;
