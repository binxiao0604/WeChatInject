...
@class MMLivePivotView, MMLiveTaskId, MMLiveView, NSArray, NSData, NSIndexPath, NSMutableArray, NSMutableSet, NSString, UICollectionView, UIImageView, UIView, WCStoryTouchToDismissView;
