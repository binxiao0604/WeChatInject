...
@class MMBaseSessionStorage, NSMutableDictionary, NSString, TemplateSessionMsgIndex, WCTDatabase;
...
@property(retain, nonatomic) TemplateSessionMsgIndex *minScanedIndex;
