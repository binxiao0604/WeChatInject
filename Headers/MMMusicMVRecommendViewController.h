...
@class MMMusicInfo, MMMusicMVModel, MMMusicMVRecommendAnimationLoadingView, MMMusicMVRecommendHeaderView, MMMusicMVRecommendTableCell, NSData, NSString, UIButton, UILabel, UIPanGestureRecognizer, UITableView, UIView, WCFinderLastestPlayVideoInfoMgr;
