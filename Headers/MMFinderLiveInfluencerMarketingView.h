...
@class CAShapeLayer, MMFinderLiveAdsItem, MMFinderLiveGoodsItem, MMFinderLiveInfluencerMarketingHeaderView, MMFinderLiveShopContext, MMFinderLiveTaskId, MMLoadingView, MMTableView, MMUILabel, NSData, NSString, OrderedDictionary, UIButton, UIPanGestureRecognizer, UIVisualEffectView, WCFinderBaseCgi, WCTimeLineFooterView;
...
- (void)loadDataWithProductList:(id)arg1 orItemList:(id)arg2;
- (id)liveTask;
- (void)stopLoading;
