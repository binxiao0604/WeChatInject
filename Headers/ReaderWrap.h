...
@class NSDate, NSMutableArray, NSString, ReaderTopNewWrap, TemplateAdvertiseOPWrap, TemplateDetailToplineWrap, TemplateFinderGameLiveOPWrap, TemplateFinderLiveOPWrap, TemplateHeaderWrap, TemplateImageTextWrap, TemplateScheduleOPWrap, TemplateWeappOPWrap, UIColor;
