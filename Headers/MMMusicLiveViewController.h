...
@class CAGradientLayer, MMGrowTextView, MMMusicDotMVDataSource, MMMusicInfo, MMMusicInfoHalfViewController, MMMusicLiveCommentModel, MMMusicLiveCommentView, MMMusicLiveLyricDisplayView, MMMusicLiveMVAuthorInfoView, MMMusicLiveMusicOperationView, MMMusicLiveVCTopBarView, MMMusicLyricsViewController, MMMusicMVPostingStateView, MMMusicVideoImageDownloader, MMScrollActionSheet, MMUIActivityIndicatorView, MMUIButton, NSString, SendAppMsgHandler, UIButton, UIImageView, UILabel, UIView, WCActionSheet, WCInputController;
@protocol MMMusicLiveViewControllerDelegate;

@interface MMMusicLiveViewController : MMUIViewController <MMMusicLiveMusicOperationViewDelegate, IMMMusicLyricServiceExt, MMMusicLiveCommentViewDelegate, InputControllerDelegate, MMMusicLiveMVAuthorInfoViewDelegate, MMMusicLiveVCTopBarViewDelegate, WCFinderDynamicFetchIconDelegate, SendAppMsgHandleDelegate, MMUIHalfScreenViewControllerDelegate, MMMusicLyricsViewControllerDelegate, TextStatePublishViewControllerDelegate, WCActionSheetDelegate, UIScrollViewDelegate, MMScrollActionSheetDelegate>
{
    int _pushedFromType;
...
- (void)doShareToWCWithImageData:(id)arg1;
- (void)doShareToWc;
- (void)doShareToFriendsWithImageData:(id)arg1;
- (void)doShareToFriends;
- (id)getUpLoadTask:(id)arg1;
- (id)getCoverImageDataWithDefault:(id)arg1;
- (id)getCoverImageData;
- (void)open3rdAppByReqWithSource:(unsigned long long)arg1;
- (void)openQQMusicAppWithSource:(unsigned long long)arg1;
