...
@class CBaseContact, CContact, CEmoticonWrap, CMessageWrap, LinkWeAppJumpWrap, MMMusicInfo, MMUIViewController, NSArray, NSMutableArray, NSString, PatWrap, PushMailWrap, TranslateInfo, UIView;
