...
//- (void)setReportUtil:(WCStoryReportUtil *)reportUtil { %log; %orig; }
//- (WCStoryReportUtil *)reportUtil { %log; WCStoryReportUtil * r = %orig; NSLog(@" = %@", r); return r; }
- (void)setNeedReportStoryEntranceExpose:(_Bool )needReportStoryEntranceExpose { %log; %orig; }
- (_Bool )needReportStoryEntranceExpose { %log; _Bool  r = %orig; NSLog(@" = %d", r); return r; }
//- (void)setStoryDataVM:(WCChatRoomStoryDataVM *)storyDataVM { %log; %orig; }
//- (WCChatRoomStoryDataVM *)storyDataVM { %log; WCChatRoomStoryDataVM * r = %orig; NSLog(@" = %@", r); return r; }
...
//- (void)setMsgReferView:(__weak MMInputMsgReferView *)msgReferView { %log; %orig; }
//- (__weak MMInputMsgReferView *)msgReferView { %log; __weak MMInputMsgReferView * r = %orig; NSLog(@" = 0x%x", (unsigned int)r); return r; }
...
//- (__weak id <BaseMsgContentInBackgroundThreadDelgate> )m_backgroundThreadDelegate { %log; __weak id <BaseMsgContentInBackgroundThreadDelgate>  r = %orig; NSLog(@" = 0x%x", (unsigned int)r); return r; }
//- (void)setM_delegate:(__weak id <BaseMsgContentDelgate> )m_delegate { %log; %orig; }
//- (__weak id <BaseMsgContentDelgate> )m_delegate { %log; __weak id <BaseMsgContentDelgate>  r = %orig; NSLog(@" = 0x%x", (unsigned int)r); return r; }
- (void)onTitleViewClicked:(id)arg1 { %log; %orig; }
- (void)onItemsExposed:(id)arg1 withOldItems:(id)arg2 { %log; %orig; }
- (_Bool)shuoldShowTipsBar:(id)arg1 { %log; _Bool r = %orig; NSLog(@" = %d", r); return r; }
...
//- (void)setMultiSelectedHandler:(CDUnknownBlockType)arg1 { %log; %orig; }
//- (void)setMultiSelectedChecker:(CDUnknownBlockType)arg1 { %log; %orig; }
...
- (void)onUserRecoverHideStoryWithUserName:(id)arg1 { %log; %orig; }
- (void)onClearUnreadStoryMarkWithUserName:(id)arg1 { %log; %orig; }
- (void)onSetUnreadStoryMarkWithUserName:(id)arg1 { %log; %orig; }
- (_Bool)storyCheckHasUnreadItem { %log; _Bool r = %orig; NSLog(@" = %d", r); return r; }
- (_Bool)storyCheckHasItem { %log; _Bool r = %orig; NSLog(@" = %d", r); return r; }
...
- (id)getChatRoomStoryEntryButton:(id)arg1 { %log; id r = %orig; NSLog(@" = %@", r); return r; }
...
- (void)scrollToMessage:(id)arg1 animated:(_Bool)arg2 { %log; %orig; }
...
//- (void)scrollViewWillEndDragging:(id)arg1 withVelocity:(CGPoint)arg2 targetContentOffset:(inout struct CGPoint *)arg3 { %log; %orig; }
...
- (id)getRightBarButtonWithMultiFlag:(_Bool)arg1 { %log; id r = %orig; NSLog(@" = %@", r); return r; }
...
- (id)getVoipBarButton { %log; id r = %orig; NSLog(@" = %@", r); return r; }
...
- (_Bool)isMsgLastSend:(id)arg1 { %log; _Bool r = %orig; NSLog(@" = %d", r); return r; }
- (id)getLastSentMsg { %log; id r = %orig; NSLog(@" = %@", r); return r; }
...
- (_Bool)jumpMPVideoView:(id)arg1 url:(id)arg2 sender:(id)arg3 { %log; _Bool r = %orig; NSLog(@" = %d", r); return r; }
